...
public class CachingDependencyResultFactory {
    ...
    public UnresolvedDependencyResult createUnresolvedDependency(ComponentSelector requested, boolean constraint, ResolvedComponentResult from,
    ...
    public ResolvedDependencyResult createResolvedDependency(ComponentSelector requested, boolean constraint, ResolvedComponentResult from, DefaultResolvedComponentResult selected) {
