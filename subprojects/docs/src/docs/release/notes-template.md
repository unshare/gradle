The Gradle team is excited to announce Gradle X.

This release features [1](), [2](), ... [n](), and more.

See the [Gradle (X-1) to X upgrade guide](userguide/upgrading_version_(X-1).html) to learn about breaking changes and considerations for upgrading from Gradle (X-1).
...
Switch your build to use Gradle X by updating your wrapper properties:
